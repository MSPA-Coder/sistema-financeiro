...
PERMISSION_DEPENDENCIES: Final[dict[str, tuple[str, ...]]] = {
    ...
    "transactions.cancel": ("transactions.view",),
    "transactions.delete": ("transactions.view",),
    "transactions.transfer": ("transactions.view",),
    "transactions.close_month": ("transactions.view",),
    "transactions.reopen_month": ("transactions.view",),
...
PERMISSION_MENU_GROUPS: Final[tuple[tuple[str, tuple[str, ...]], ...]] = (
    ...
    ("Movimentação · Lançamentos", (
        ...
        "transactions.realize", "transactions.cancel", "transactions.delete",
        "transactions.transfer", "transactions.close_month", "transactions.reopen_month",
    )),
    ...
    ("Configurações · Banco de dados", (
        "settings.backup.run", "settings.restore.run", "settings.database.optimize",
...
PROFILE_DEFINITIONS: Final[dict[str, dict]] = {
    "consulta": {
        ...
        "permissions": {
            ...
            "reports.upcoming_movements.view", "reports.account_position.view",
    ...
    "gestor": {
        ...
        "permissions": {
            ...
            "transactions.cancel", "transactions.transfer", "transactions.close_month",
            "transactions.reopen_month", "projections.view",
            "reports.upcoming_movements.view", "reports.account_position.view",
            ...
            "settings.view", "settings.theme.update", "settings.backup.run",
